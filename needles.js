	...
	this.draw = function() {
		...
		for (var i = 0; i < this.plotsDown; i++) {
			for (var j = 0; j < this.plotsAcross; j++) {
                ...
                var x = this.pad/this.plotsAcross + j*width/this.plotsAcross;
				var y = this.pad/this.plotsDown + i*height/this.plotsDown;
				var w = this.plotWidth - this.pad/this.plotsAcross;
				var h = this.plotHeight - this.pad/this.plotsDown;
